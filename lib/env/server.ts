...
const stripeMode = readStripeMode();
...
export const serverEnv = {
  ...
  STRIPE_WEBHOOK_SECRET: readStripeModeRequired(
    stripeMode,
    {
  ...
  STRIPE_PRICE_STANDARD: readStripeModeRequired(
    stripeMode,
    {
  ...
  STRIPE_PRICE_PRO: readStripeModeRequired(
    stripeMode,
    {
  ...
  STRIPE_PRICE_TURBO: readStripeModeRequired(
    stripeMode,
    {
  ...
  STRIPE_PRICE_STANDARD_YEARLY: readStripeModeOptional(stripeMode, {
  ...
  STRIPE_PRICE_PRO_YEARLY: readStripeModeOptional(stripeMode, {
    live: ["STRIPE_PRICE_PRO_YEARLY_LIVE", "STRIPE_PRICE_PRO_YEARLY"],
    test: ["STRIPE_PRICE_PRO_YEARLY_TEST", "STRIPE_PRICE_PRO_YEARLY"],
  }),
  STRIPE_PRICE_TURBO_YEARLY: readStripeModeOptional(stripeMode, {
